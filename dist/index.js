...
var _v3 = _interopRequireDefault(__nccwpck_require__(96));
...
var lib_core = __nccwpck_require__(21);
;// CONCATENATED MODULE: ./action.js


async function action() {
    core.setOutput("new_tag", "output");
}
...
async function run() {
  try {
    await (0,action_namespaceObject["default"])();
  } catch (error) {
